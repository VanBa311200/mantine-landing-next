...
const SENTRY_UNREACHABLE = "sentry-unreachable";
const sentryIssuesUrl =
  process.env.NEXT_PUBLIC_SENTRY_ISSUES_URL ??
  "https://personal-project-in.sentry.io/issues/?project=4511155856080896";
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    async function checkConnectivity() {
      ...
      setIsConnected(result !== SENTRY_UNREACHABLE);
    }
    ...
    <>
      <main>
        ...
        <button
          ...
          disabled={!isConnected || !isProduction}
        >
